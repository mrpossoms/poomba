...
class Classifier:
    ...
    def classify(self, img, stride_w=16, stride_h=8):
        ...
        activation = np.zeros((_h // stride_h, _w // stride_w))
        ...
        log.info('Classification time: %f sec', time.time() - start)
